...
const api: ElectronAPI = {
  ...
  checkOutProject: (filePath: string, userName: string, steal?: boolean) => ipcRenderer.invoke('check-out-project', filePath, userName, steal),
  checkInProject: (filePath: string, userName: string) => ipcRenderer.invoke('check-in-project', filePath, userName),
  readQdpxForCompare: (filePath: string) => ipcRenderer.invoke('read-qdpx-for-compare', filePath),
  importMergeBinary: (comparisonFilePath: string, handle: string) => ipcRenderer.invoke('import-merge-binary', comparisonFilePath, handle),
  readCompareBinary: (comparisonFilePath: string, handle: string) => ipcRenderer.invoke('read-compare-binary', comparisonFilePath, handle),
